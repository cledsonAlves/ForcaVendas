...
// //////////////////////////////////////////////////////////////////////////////////////
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Array temporario Menu.produtos
		List<Produto> listaTemp = Menu.produtos;

		for (int x = 0; x < listaTemp.size(); x++) {
			if (listaTemp.get(x).getDescricao().contains("XAMPU")) {
		...
		listaItens.setOnItemClickListener(new OnItemClickListener() {
			...
			//  verifica se o dialogo esta aberto ..		
	               ExibeDialog();	
	...
	private TextWatcher filterTextWatcher = new TextWatcher() {
		...
		public void onTextChanged(CharSequence s, int start, int before,
			...
			adapter = new AdaptadorProduto(Produtos1.this, novaLista);
			listaItens.setAdapter(adapter);
	...
	//  busca os diretorios das fotos 
		...
		// Bitmap bmp2 =
		// BitmapFactory.decodeFile("/sdcard/fotoProdutos/default.png");
