...
public class TelaListaPedido extends ListActivity implements OnItemLongClickListener {
	...
	//  TEMPORARIO para fazer a inversao da lista, ou seja o utimo pedido deve ser o primeiro
		...
		temp  = logica.buscaPedido(getApplicationContext(),"TpVenda not like 'Orçamento' and Status = 'P'");
						...
						mhandler.post(new Runnable() {
							public void run() {
							  if (retorno ){
							   ...
							   logica.atualizaStatus(getApplicationContext(), pedido.getNumero());
