...
public class TelaConsultaClientes extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listaItens.setOnItemLongClickListener(new OnItemLongClickListener() {
			public boolean onItemLongClick(AdapterView arg0, View view, int position,
				...
				Toast.makeText(getApplicationContext(),"Ok" + cliente.getNome(),Toast.LENGTH_LONG).show();
	...
	private TextWatcher filterTextWatcher = new TextWatcher() {
		...
		public void onTextChanged(CharSequence s, int start, int before,
			...
			adapter = new AdaptadorCliente(TelaConsultaClientes.this, novaLista);
			listaItens.setAdapter(adapter);
