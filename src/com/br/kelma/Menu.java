...
public class Menu extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle icicle) {
	    ...
	    edit.setText(Html.fromHtml(
	            "Força de Vendas - versão 1.4 :::: Acesse nossa revista digital " +
	...
	public boolean onCreateOptionsMenu(android.view.Menu menu) {
		...
		// SubMenu consulta
		SubMenu subConsulta = menu.addSubMenu("Atualizações");
		subConsulta.setIcon(R.drawable.pesquisa64);
		item = subConsulta.add(0, conCli, 0, "Atualizar Cliente");
		item = subConsulta.add(0, conProd, 0, "Atualizar Produtos");
		item = subConsulta.add(0, conRep, 0, "Atualizar Planos");
		...
		item = subConf.add(0, parametros, 0, "Atualizações");
