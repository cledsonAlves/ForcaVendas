...
import android.widget.EditText;
	...
	public class Cpf extends EditText {
		...
		public Cpf(Context context, AttributeSet attrs, int defStyle) {
		...
		public String getCleanText() {
			String text = Cpf.this.getText().toString();
		...
		private void initialize() {
			...
			this.addTextChangedListener(new TextWatcher() {
				public void afterTextChanged(Editable s) {
					 ...
					 */
					isUpdating = true;
					Cpf.this.setText(cpf);
	 
					Cpf.this.setSelection(positioning[length]);
